  ...
  return (
    <section id="portfolio" className="relative py-20 md:py-32 bg-[#0a0a0a]">
      <div className="container mx-auto px-6">
        {/* Sticky Header Unit */}
        <div className="sticky top-20 md:top-28 z-40 bg-[#0a0a0a]/80 backdrop-blur-xl py-6 mb-8 border-b border-white/5">
          <motion.div 
        ...
        {/* Cinematic Internal Scroll Container */}
        <div className="relative">
          <div className="max-h-[80vh] overflow-y-auto custom-luxury-scrollbar scrolling-sanctuary pr-4 md:pr-6 pb-20">
              ...
              {filteredItems.map((item, i) => (
                <motion.div
                  ...
                  className={`relative overflow-hidden rounded-2xl md:rounded-3xl group ${
                    i === 0 ? 'md:row-span-2 min-h-[300px] md:min-h-auto' : 'h-[250px] md:h-[400px]'
                  } ${i === 3 ? 'md:col-span-2' : ''}`}
                >
                  <img 
                    src={item.image_url} 
                    alt={item.title} 
                    className="w-full h-full object-cover reveal-image grayscale-[0.2] group-hover:grayscale-0 transition-all duration-[1.5s]" 
                  />
                  <div className="absolute inset-0 bg-gradient-to-t from-black/90 via-black/20 to-transparent flex items-end p-6 md:p-8 opacity-0 group-hover:opacity-100 transition-opacity duration-700">
            ...
            {/* Bottom CTA within Scroll for flow */}
          ...
          {/* Subtle Mask to indicate more content */}
