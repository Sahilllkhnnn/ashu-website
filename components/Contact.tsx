            ...
            <motion.form variants={riseVariants} onSubmit={handleEnquiry} className="space-y-8 md:space-y-10">
              <div className="grid sm:grid-cols-2 gap-8 md:gap-10">
                <div className="space-y-3">
                  ...
                  <input required value={formData.name} onChange={e => setFormData({...formData, name: e.target.value})} type="text" className="w-full bg-white/[0.03] border border-white/10 rounded-2xl px-6 py-4 text-white text-sm focus:outline-none focus:border-[#d4af37]/50 focus:shadow-[0_0_20px_rgba(212,175,89,0.1)] transition-all duration-500" placeholder={t('feedback.placeholder_name')} />
                </div>
                <div className="space-y-3">
                  <label className="text-[10px] uppercase font-bold tracking-[0.3em] text-white/30 ml-2">{t('modal.label_phone')}</label>
                  <input required value={formData.phone} onChange={e => setFormData({...formData, phone: e.target.value})} type="tel" className="w-full bg-white/[0.03] border border-white/10 rounded-2xl px-6 py-4 text-white text-sm focus:outline-none focus:border-[#d4af37]/50 focus:shadow-[0_0_20px_rgba(212,175,89,0.1)] transition-all duration-500" placeholder="+91 XXXX" />
                </div>
              </div>
              <div className="grid sm:grid-cols-2 gap-8 md:gap-10">
                <div className="space-y-3">
                  <label className="text-[10px] uppercase font-bold tracking-[0.3em] text-white/30 ml-2">{t('modal.label_date')}</label>
                  <input required value={formData.date} onChange={e => setFormData({...formData, date: e.target.value})} type="date" className="w-full bg-white/[0.03] border border-white/10 rounded-2xl px-6 py-4 text-white text-sm focus:outline-none focus:border-[#d4af37]/50 focus:shadow-[0_0_20px_rgba(212,175,89,0.1)] transition-all duration-500 [color-scheme:dark]" />
                </div>
                <div className="space-y-3">
                  <label className="text-[10px] uppercase font-bold tracking-[0.3em] text-white/30 ml-2">{t('modal.label_city')}</label>
                  <input required value={formData.city} onChange={e => setFormData({...formData, city: e.target.value})} type="text" className="w-full bg-white/[0.03] border border-white/10 rounded-2xl px-6 py-4 text-white text-sm focus:outline-none focus:border-[#d4af37]/50 focus:shadow-[0_0_20px_rgba(212,175,89,0.1)] transition-all duration-500" placeholder="Chandia / Umariya" />
                </div>
              </div>
              <div className="space-y-3">
                <label className="text-[10px] uppercase font-bold tracking-[0.3em] text-white/30 ml-2">{t('contact.tag')}</label>
                <textarea rows={4} value={formData.msg} onChange={e => setFormData({...formData, msg: e.target.value})} className="w-full bg-white/[0.03] border border-white/10 rounded-2xl px-6 py-4 text-white text-sm focus:outline-none focus:border-[#d4af37]/50 focus:shadow-[0_0_20px_rgba(212,175,89,0.1)] transition-all duration-500 resize-none" placeholder={t('contact.placeholder_vision')}></textarea>
              </div>
              <button
                type="submit"
